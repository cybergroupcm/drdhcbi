...
(function (undefined) {
    ...
    // format tokens
        formattingTokens = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|BBBB|BB|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|x|X|zz?|ZZ?|.)/g,
    ...
    function addTimeToArrayFromToken(token, input, config) {
        ...
        switch (token) {
            ...
            case 'BB' :
                datePartArray[YEAR] = input + (input > 84 ? 2400 : 2500) - 543;
                break;
            case 'BBBB' :
                datePartArray[YEAR] = input - 543;
                break;
