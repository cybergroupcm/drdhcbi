    ...
    $("#bt_add").click(function () {
        if($('#channel_name').val() != ""){
            ...
            $.ajax({
                ...
                url: base_url+'api/setting/channel/',  //the url to call
                data: { channel_id: channel_id , channel_name: channel_name },     //Data sent to server
            ...
            swal('กรุณากรอกช่องทางรับเรื่อง','','error');
        }
