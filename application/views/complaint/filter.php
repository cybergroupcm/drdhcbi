    ...
    <div class="modal fade" id="filter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="GET" action="<?php base_url("complaint/dashboard");?>" name="form_filter" id="form_filter">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="col-sm-7">
                                    <select name="filter[]" id="type_complaint"
                                            class="selectpicker type_complaint" multiple data-width="95%">
                                        <?php
                    ...
                    <div class="modal-footer" style="text-align: center;">
                        <button type="submit" id="btFilter" class="btn btn-primary">กรองข้อมูล</button>
