                ...
                <div class="box-body">
                    ...
                    <table style="width: 100%;border-collapse: collapse;font-size: 13px;">
                        ...
                        <tr>
                            ...
                            <th style="vertical-align: middle;text-align: center;border: 1px solid black;padding: 5px;" colspan="<?php echo count($channel_max);?>">ช่องทางการร้องทุกข์</th>
                            <th style="vertical-align: middle;text-align: center;border: 1px solid black;<?php echo $td_width;?>" rowspan="2">รวม</th>
                        </tr>
                        <tr>
                            <?php foreach($channel_max as $key => $value){ ?>
                            <th style="vertical-align: middle;text-align: center;border: 1px solid black;<?php echo $td_width;?>"><?php echo $value; ?></th>
                            <?php } ?>
