                ...
                <div class="box-body">
                    ...
                    <table style="width: 100%;border-collapse: collapse;font-size: 13px;">
                        ...
                        foreach($result_progress AS $key_result=>$val) {
                            ...
                            if($val['result_sum'] != '') {
                                echo '<tr>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . $val['result_sum']['column1'] . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column2']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column3']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column4']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column5']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column6']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column7']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column8']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column9']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column10']) . '</td>';
                                echo '<td class="text-center" style="text-align: right;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;vertical-align: top;padding: 5px;">' . number_format($val['result_sum']['column11']) . '</td>';
                                echo '</tr>';
                            }
                        }
                        ?>
