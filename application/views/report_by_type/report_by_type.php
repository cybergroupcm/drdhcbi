            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-xs-12 text-right" style="margin-bottom: 5px;">
                        ...
                        <a href="<?php echo base_url('report/report_by_type_pdf'.$param_pdf); ?>" class="btn btn-default" role="button"  title="สั่งพิมพ์" target="_blank">
                            <i class="fa fa-print" aria-hidden="true" style="cursor: pointer;font-size: 2em;"></i>
                        </a>
                        <a href="<?php echo base_url('report/report_by_type_excel'.$param_pdf); ?>" class="btn btn-default" role="button" title="ส่งออก Excel" target="_blank">
