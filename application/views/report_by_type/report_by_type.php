...
$this->load->view('report_by_type/search');
?>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"> รายงานสถิติเรื่องร้องเรียนร้องทุกข์(ลักษณะเรื่อง)</h3>
                </div>
                <div class="box-body">
                    <div class="col-xs-12 text-right" style="margin-bottom: 5px;">
                        <?php
                        $param_pdf = "?year=".$_GET['year']."&subject_id=".$_GET['subject_id']."&partid=".$_GET['partid']."&province_id=".$_GET['province_id']."&district_id=".$_GET['district_id']."&address_id=".$_GET['address_id'];
                        ...
                        echo '<a href="'.base_url('report/report_by_type_pdf'.$param_pdf).'" style="color: #333333;" target="_blank"><i class="fa fa-print" aria-hidden="true" style="cursor: pointer;font-size: 3em;" title="สั่งพิมพ์"></a></i>  ';
                        echo '<a href="'.base_url('report/report_by_type_excel'.$param_pdf).'" style="color: #333333;" target="_blank" id="export"><i class="fa fa-file-excel-o" aria-hidden="true" style="cursor: pointer;font-size: 3em;" title="ส่งออก Excel"></a></i>';
                        ?>
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped table-hover dataTable">
                        <thead>
                        <tr>
                            <th class="text-center" style="vertical-align: middle;" rowspan="2">ลักษณะเรื่องร้องทุกข์</th>
...
foreach($current_subject AS $key=>$val){
    $data_value .= '{data: [';
    $sum_type = 0;
