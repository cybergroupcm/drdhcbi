        ...
        <div class="modal-dialog" style="width: 700px;">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label class="col-sm-5 text-right">
                                            สถานะเรื่องร้องทุกข์ :
                                        </label>
                                        <label class="col-sm-7">
                                            <?php
                                            $current_status_arr = @$current_status;
                                            $current_status_arr[''] = '--ไม่ระบุ--';
                                            ksort($current_status_arr);
                                            echo form_dropdown([
                                                'id' => 'current_status_id',
                                                'class' => 'form-control',
                                            ], $current_status_arr, $_GET['current_status_id']);
                                            ?>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="modal-footer" style="text-align: center;">
                    <button type="button" name="btSearchStatus" id="btSearchStatus" class="btn btn-primary">ค้นหาข้อมูล</button>
                    <button type="button" name="btClearStatus" id="btClearStatus" class="btn btn-default" data-dismiss="modal">ล้างค่า</button>
                </div>
            </div>
        </div>
    </div>
