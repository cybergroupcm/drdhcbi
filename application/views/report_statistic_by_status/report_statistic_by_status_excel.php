            ...
            <div class="box">
                <div class="box-body">
                    <table style="width: 100%;border-collapse: collapse;font-size: 16pt;">
                        <thead>
                        <tr>
                            <th class="text-center" style="vertical-align: middle;text-align: center;padding: 5px;" colspan="14">รายงานสถิติเรื่องร้องเรียนร้องทุกข์(สถานะ)</th>
                        </tr>
                        <tr>
                            <th class="text-center" style="vertical-align: middle;text-align: center;border: 1px solid black;border-width:thin;" rowspan="2">สถานะเรื่องร้องทุกข์</th>
