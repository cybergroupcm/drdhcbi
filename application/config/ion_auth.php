...
*/
$config['tables']['users']           = 'au_users';
$config['tables']['groups']          = 'au_groups';
$config['tables']['users_groups']    = 'au_users_groups';
...
$config['member_group']                = 'members';             // Default members group, use name
